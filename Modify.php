...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="Modify.php" class="active"><i class="fas fa-edit"></i>Modify</a></li>
    ...
    <section>
        <div id="Modify">
            ...
            <div class="Modify">
                ...
                <button type="button" id="mod">Validate</button>
            </div>
        </div>
        <div id="details" style="display:none">
          ...
          <div id="Modif" >
            <center><h3>Modify Customer Details</h3></center>
            <div id="detl">
             <form id="form">
                <br><br>
