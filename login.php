...
<body>
	<header>
        ...
        <form name="form" id="form1" action="logincheck.php" method="POST">
            ...
            <span id="mail"></span>
            <div class="input"><input type="submit" name="submits" value="login" id="register"></div>
		</form>
		<center><h6></h6><a href="#" style="color: red; font-size: 1.5vw;">forget password ?</a></h6></center>
	</header>
</body>
</html>