...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li>
               <a href="order.php" class="Odbtn"><i class="fas fa-cart-arrow-down"></i>Order
               <span id="span" class="fas fa-caret-down first"></span>
               </a>
               <ul class="Odbtn" style="display: block">
	...
	<section>
        <div id="order">
            ...
            <div class="order">
                <input type="text" placeholder="STB No. #">&nbsp &nbsp &nbsp
                <button type="button" id="sear">Order</button>&nbsp
